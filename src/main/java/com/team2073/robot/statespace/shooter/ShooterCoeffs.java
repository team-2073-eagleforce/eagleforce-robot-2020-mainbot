...
public class ShooterCoeffs {
  public static StateSpacePlantCoeffs<N2, N1, N1> makeShooterPlantCoeffs() {
    ...
    Matrix<N2, N1> B = MatrixUtils.mat(Nat.N2(), Nat.N1()).fill(1.30402386, 0.0);
  ...
  public static StateSpaceControllerCoeffs<N2, N1, N1>
    ...
    Matrix<N1, N2> K = MatrixUtils.mat(Nat.N1(), Nat.N2()).fill(0.39952007, 1);
    Matrix<N1, N2> Kff = MatrixUtils.mat(Nat.N1(), Nat.N2()).fill(0.76685713404, 0);
    Matrix<N1, N1> Umin = MatrixUtils.mat(Nat.N1(), Nat.N1()).fill(0);
    Matrix<N1, N1> Umax = MatrixUtils.mat(Nat.N1(), Nat.N1()).fill(5);
  ...
  public static StateSpaceObserverCoeffs<N2, N1, N1>
    ...
    Matrix<N2, N1> K = MatrixUtils.mat(Nat.N2(), Nat.N1()).fill(0.9999960000314957, 1);
